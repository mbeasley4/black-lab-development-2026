...
export default function TechnologiesExperience() {
    return (
        <section className="w-full bg-gradient-to-b from-purple-950/30 via-slate-950 to-black text-white py-24 relative overflow-hidden">
            ...
            <div className="mx-auto max-w-[1500px] px-6 relative z-10">
                ...
                <div className="max-w-6xl mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 bg-gradient-to-r from-cyan-400 via-blue-400 to-sky-400 bg-clip-text text-transparent">
                                    ...
                                    <ul className="space-y-2.5 text-sm text-slate-400">
                                        {area.items.map((item) => (
                                            <li key={item} className="leading-relaxed group-hover:text-slate-300 transition-colors duration-300 flex items-start">
                                                <span className="mr-2 mt-1.5 h-1.5 w-1.5 rounded-full bg-cyan-500/50 flex-shrink-0" />
                                                <span>{item}</span>
                                            </li>
                                        ))}
                                    </ul>
                ...
                <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="group rounded-2xl border-2 border-slate-800/50 bg-gradient-to-br from-slate-900/50 to-blue-950/30 p-10 transition-all duration-500 hover:border-cyan-500/50 hover:shadow-xl hover:shadow-cyan-500/20 backdrop-blur-sm relative overflow-hidden">
                        {/* Hover gradient */}
                    ...
                    <div className="group rounded-2xl border-2 border-slate-800/50 bg-slate-900/50 p-10 flex items-center gap-6 transition-all duration-500 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/20 backdrop-blur-sm relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex items-center gap-6">
                            <img
                                ...
                                className="h-20 w-auto flex-shrink-0 transition-transform duration-500 group-hover:scale-110"
                            />
                            <div>
