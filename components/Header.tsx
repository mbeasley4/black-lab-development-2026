        ...
        <>
            ...
            {mobileOpen && (
                <div className="fixed inset-0 z-60 lg:hidden">
                    ...
                    <nav
                        ...
                        className="absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-[#111214] border-l border-amber-500/40
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center justify-between mb-6 pb-4 border-b border-amber-500/15">
                            <Link
                                href="/"
                                onClick={closeDrawer}
                                className="flex items-center gap-2 group rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70"
                            >
                        ...
                        <div className="relative z-10 flex flex-col flex-1">
                            ...
                            >
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between gap-3 py-3.5 text-[16px] uppercase tracking-widest font-medium transition-all duration-300
                                        focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70 rounded-sm
                                        ${servicesActive
                                            ? "text-amber-500 drop-shadow-[0_0_8px_rgba(245,158,11,0.7)]"
                                            : "text-[#c8c8c8] hover:text-amber-400"
                                        }`}
                                >
                                    <span className="flex items-center gap-3">
                                        <span className={`shrink-0 w-0.5 h-4 rounded-full transition-all duration-300
                                            ${servicesActive ? "bg-amber-500 shadow-[0_0_6px_rgba(245,158,11,0.8)]" : "bg-amber-500/20"}`}
                                        />
                                        Services
                                    </span>
                                ...
                                >
                                    <div className="ml-4 border-l border-amber-500/15 pl-4 py-1 flex flex-col">
                                        {SERVICE_LINKS.map((s) => {
                                            ...
                                            return (
                                                <Link
                                                    ...
                                                    className={`py-2 text-[13px] uppercase tracking-[0.12em] transition-colors duration-200 rounded-sm
                                                        focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70
                                                        ${active ? "text-amber-500" : "text-[#a8a8a8] hover:text-amber-400"}`}
                                                >
                                                    {s.label}
                                                </Link>
                                            );
                            ...
                            <div className="h-px bg-linear-to-r from-amber-500/12 via-amber-500/6 to-transparent" />
                            ...
                            >
                                ...
                                >
                                    <span className="flex items-center gap-3">
                                        <span className={`shrink-0 w-0.5 h-4 rounded-full transition-all duration-300
                                            ${industriesActive ? "bg-amber-500 shadow-[0_0_6px_rgba(245,158,11,0.8)]" : "bg-amber-500/20"}`}
                                        />
                                        Industries
                                    </span>
                            ...
                            {plainNav.map((item, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <span className={`shrink-0 w-0.5 h-4 rounded-full transition-all duration-300
                                                ${active ? "bg-amber-500 shadow-[0_0_6px_rgba(245,158,11,0.8)]" : "bg-amber-500/20"}`}
                                            />
                                            {item.label}
                                        </Link>
                                    </div>
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    onClick={closeDrawer}
                                    className="flex items-center gap-2 py-3 text-[12px] uppercase tracking-[0.18em] text-[#8a8a8a] hover:text-amber-400 transition-colors duration-200 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70"
                                >
            ...
            <header className="fixed top-0 z-50 w-full bg-[#0b0b0c] text-[#e5e7eb] border-b border-amber-500/15">
                ...
                >
                    ...
                    <Link
                        href="/"
                        className="flex items-center gap-2 uppercase group rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70"
                        onClick={closeDrawer}
                    >
                        <div className="relative">
                            <Image
                        ...
                        <div className="flex flex-col gap-1 uppercase leading-none whitespace-nowrap">
                            ...
                            >
                                Development
                                <span className="pointer-events-none absolute inset-0 text-amber-500 blur-sm opacity-70 animate-[neonFlicker_2.2s_linear_1]">
                                    Development
                                </span>
                            </span>
                        </div>
                    ...
                    >
                        ...
                        >
                            <Link
                                ...
                                className="relative group inline-flex items-center gap-1.5 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70"
                            >
                                <span
                                ...
                                <span
                                    className={`absolute left-0 -bottom-1 h-0.5 w-full origin-left transition-all duration-300 bg-amber-500
                                        ${servicesActive || openMega === "services"
                                            ? "scale-x-100 shadow-[0_0_8px_rgba(245,158,11,0.7)]"
                                            : "scale-x-0 shadow-[0_0_8px_rgba(245,158,11,0.5)] group-hover:scale-x-100"
                                        }`}
                                />
                            </Link>
                                ...
                                <div className="relative overflow-hidden rounded-lg bg-[#111214] border border-amber-500/20 shadow-[0_24px_60px_-12px_rgba(0,0,0,0.8),0_0_40px_rgba(245,158,11,0.12)]">
                                    ...
                                    <div className="relative border-t border-amber-500/10 px-5 py-3 flex items-center justify-between bg-black/30">
                                        ...
                                        <Link
                                            href="/contact"
                                            onClick={() => setOpenMega(null)}
                                            className="text-[11px] uppercase tracking-[0.16em] text-amber-500 hover:text-amber-400 transition-colors duration-200 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70"
                                        >
                                            Schedule a Call →
                                        </Link>
                                    </div>
                                                ...
                                                <li key={s.label}>
                                                    <Link
                                                        ...
                                                        className={`group/ind flex items-center gap-2.5 px-3 py-2 rounded-sm text-[12px] normal-case tracking-normal transition-colors duration-200
                                                            focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70
                                                            ${active ? "text-amber-500 bg-amber-500/6" : "text-[#b8b8b8] hover:text-amber-400 hover:bg-amber-500/4"}`}
                                                    >
                                                        <span className={`w-1 h-1 rounded-full transition-all duration-200 ${active ? "bg-amber-500" : "bg-amber-500/30 group-hover/ind:bg-amber-500"}`} />
                                                        {s.label}
                                                    </Link>
                                                </li>
                                            );
                        ...
                        {plainNav.map((item) => {
                            const active = isActive(item.href);
                            return (
                                <Link key={item.label} href={item.href} className="relative group rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/70">
                                    <span
                                        className={`transition-all duration-300 ${
                                            active
                                                ? "text-amber-500 drop-shadow-[0_0_8px_rgba(245,158,11,0.7)]"
...
function Chevron({ open, small = false }: { open: boolean; small?: boolean }) {
    return (
        <svg
            ...
            className={`${small ? "w-3 h-3" : "w-4 h-4"} shrink-0 transition-transform duration-300 ${open ? "rotate-180 text-amber-500" : ""}`}
        >
