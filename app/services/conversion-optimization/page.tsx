...
export const metadata = {
  title: "B2B Website Conversion Optimization | Black Lab Development",
  description:
    "Traffic without conversions is just overhead. We audit, diagnose, and fix the specific reasons your B2B website isn't generating qualified leads.",
};
